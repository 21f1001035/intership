...
# Import Base and all models so that autogenerate can detect changes.
from app.db.session import Base  # noqa: E402
import app.models  # noqa: E402, F401  — side-effect import to register all mappers
...
# Override the sqlalchemy.url from the .ini with the value from our settings.
